...
"??" 		{ return new_symbol(sym.ISNULL, yytext()); }


"+++" 		{ return new_symbol(sym.INCINC, yytext()); }
"~" 		{ return new_symbol(sym.REVERSE, yytext()); }
...
"'" [\040-\176] "'"               { return new_symbol(sym.CHARACTER, yytext().charAt(1)); }
