...
public class FactorDesignWithParams extends FactorWrapper {

    private Designator Designator;
    private ActualParamList ActualParamList;

    public FactorDesignWithParams (Designator Designator, ActualParamList ActualParamList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignWithParams(\n");
