...
public class ListOfFormParamsClass extends ListOfFormParams {

    private ListOfFormParams ListOfFormParams;
    private FormParam FormParam;

    public ListOfFormParamsClass (ListOfFormParams ListOfFormParams, FormParam FormParam) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ListOfFormParamsClass(\n");
